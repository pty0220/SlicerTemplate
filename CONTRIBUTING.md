...
There are many ways to contribute to snm.

  * Submit a feature request or bug, or add to the discussion on the [snm issue tracker][is]
  * Submit a [Pull Request][pr] to improve snm.
...
If you are new to snm development and you don't have push access to the snm
...
When submitting a PR, make sure to add a `Cc: @snm/developers` comment to
notify snm developers of your awesome contributions. Based on the
...
* You do NOT have push access: A snm core developer will integrate your PR.
...
[pr]: https://github.com/snm/snm/merge_requests
[is]: https://github.com/snm/snm/issues
