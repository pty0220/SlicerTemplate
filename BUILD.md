Build and Package snm
==============================

This document summarizes how to build and package snm on Windows.

snm is a custom Slicer application. Reading the [3D Slicer Developer Documentation](https://slicer.readthedocs.io/en/latest/developer_guide/index.html) may help answer additional questions.
...
* Setting up your git account:
    ...
    * If not already done, email `FirstName LastName <firstname.lastname@snm.com>` to be granted access to
    the [snm/snm](https://github.com/snm/snm) repository.
...
mkdir W
cd /c/W
git clone https://github.com/snm/snm.git s
```
...
3. Open `C:\W\sR\snm.sln`, select `Release` and build the project.
